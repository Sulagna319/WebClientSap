...
public class WebDriverHelper {
    ...
    public static void launchBrowser() throws ClassNotFoundException{
        ...
        driver.get("http://rdv-005729.hylandqa.net:8080/webclient/ ");
    ...
    public static void explicitwaitVisible(WebElement element) throws NoSuchElementException {
    ...
    public static void explicitwaitCickable(WebElement element) throws NoSuchElementException {
